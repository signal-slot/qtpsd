...
lv_obj_t * main_screen_create(lv_obj_t * parent)
{
    ...
    }
    {
        ...
        lv_obj_set_pos(obj_1, 25, 24);
        lv_obj_set_size(obj_1, 253, 151);
        ...
        lv_label_set_text(obj_1, "This is justified text that should wrap across multiple lines in a text box.");
    }
    return root;
}
