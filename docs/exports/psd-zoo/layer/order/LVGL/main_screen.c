...
lv_obj_t * main_screen_create(lv_obj_t * parent)
{
    ...
    }
    {
        ...
        lv_image_set_src(obj_1, "A:images/bottom_red.png");
    }
    {
        lv_obj_t * obj_2 = lv_image_create(root);
        lv_obj_set_pos(obj_2, 20, 20);
        lv_obj_set_size(obj_2, 200, 200);
        lv_image_set_src(obj_2, "A:images/middle_green.png");
    }
    {
        lv_obj_t * obj_3 = lv_image_create(root);
        lv_obj_set_pos(obj_3, 40, 40);
        lv_obj_set_size(obj_3, 200, 200);
        lv_image_set_src(obj_3, "A:images/top_blue.png");
    }
    return root;
}
