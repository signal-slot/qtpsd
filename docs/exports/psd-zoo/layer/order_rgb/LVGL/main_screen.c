...
lv_obj_t * main_screen_create(lv_obj_t * parent)
{
    ...
    }
    {
        ...
        lv_image_set_src(obj_1, "A:images/red_bottom.png");
    }
    {
        lv_obj_t * obj_2 = lv_image_create(root);
        lv_obj_set_pos(obj_2, 50, 50);
        lv_obj_set_size(obj_2, 100, 100);
        lv_image_set_src(obj_2, "A:images/green_middle.png");
    }
    {
        lv_obj_t * obj_3 = lv_image_create(root);
        lv_obj_set_pos(obj_3, 80, 80);
        lv_obj_set_size(obj_3, 100, 100);
        lv_image_set_src(obj_3, "A:images/blue_top.png");
    }
    return root;
}
