        ...
        ZStack {
            Group {
                ...
                Text("")
                    ...
                    .frame(width: 0.0, height: 72.0)
                    .position(x: 38.0, y: 67.0)
                Text("文字列中に\n改行")
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    .frame(width: 144.0, height: 88.0)
                    .position(x: 241.0, y: 45.0)
                Text("Shift\n+改行")
                    .font(.custom("Koz Go Pr6N", size: 30))
                    .foregroundStyle(Color(red: 0.918, green: 0.763, blue: 0.763))
                    .multilineTextAlignment(.center)
                    .frame(width: 86.0, height: 88.0)
                    .position(x: 68.0, y: 145.0)
                Text("段落テキストは折り返される")
