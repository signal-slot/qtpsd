        ...
        ZStack {
            Group {
                ...
                Text("")
                    ...
                    .frame(width: 0.0, height: 81.0)
                    .position(x: 38.0, y: 71.5)
                Text("文字列中に\n改行")
                    .font(.custom("Source Han Sans", size: 30))
                    .foregroundStyle(Color(red: 0.918, green: 0.763, blue: 0.763))
                    .multilineTextAlignment(.center)
                    .frame(width: 160.0, height: 98.0)
                    .position(x: 82.0, y: 50.0)
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    .position(x: 241.0, y: 50.0)
                Text("Shift\n+改行")
                    .font(.custom("Koz Go Pr6N", size: 30))
                    .foregroundStyle(Color(red: 0.918, green: 0.763, blue: 0.763))
                    .multilineTextAlignment(.center)
                    .frame(width: 86.0, height: 98.0)
                    .position(x: 68.0, y: 150.0)
                Text("段落テキストは折り返される")
